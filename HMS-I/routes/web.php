...
route::post('/forgot',[AuthController::class,'forgotpost'])->name('forgot.post');
...
route::get('/admin/{id}',[AuthController::class,'admin'])->name('admin.profile');
route::post('/adminup/{id}',[AuthController::class,'adminup'])->name('admin.update');
